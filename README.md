...
One can draw a map with the course of a chosen train and make a video out of it using the gganimate package. See the [code](making_a_video_of_a_train).

Here is an example:

[tada](video/07703mapOne.mp4)
